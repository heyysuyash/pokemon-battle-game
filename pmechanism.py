...
def shopfight():
  ...
  if tutorial >= 1:
    print("3: Free Roam")
  print("Type 'Help' to view help file.")
  askshop = input()
...
def savedata():
  ...
  with open(saveuser, 'wb') as file:
    pickle.dump(password,file)
    pickle.dump(tutorial,file)
    pickle.dump(wins,file)
    pickle.dump(loses,file)
    pickle.dump(coins,file)
    pickle.dump(ppokemon,file)
    pickle.dump(potion,file)
    pickle.dump(super_potion,file)
    pickle.dump(hyper_potion,file)
    pickle.dump(max_potion,file)
    pickle.dump(energy_root,file)
    pickle.dump(ultra_potion,file)
    pickle.dump(trainer,file)
    pickle.dump(badges,file)
    pickle.dump(trainerwins,file)
    pickle.dump(water_count,file)
    pickle.dump(rock_count,file)
    pickle.dump(fire_count,file)
    pickle.dump(electric_count,file)
    pickle.dump(dragon_count,file)
    pickle.dump(psychic_count,file)
    pickle.dump(all_count,file)
    pickle.dump(resistance_count,file)
    pickle.dump(null_count,file)
    pickle.dump(pi_moves,file)
    pickle.dump(sq_moves,file)
    pickle.dump(ch_moves,file)
    pickle.dump(drag_moves,file)
    pickle.dump(mew_moves,file)
    pickle.dump(psy_moves,file)
    pickle.dump(jig_moves,file)
    pickle.dump(b_moves,file)
    pickle.dump(onix_moves,file)
    pickle.dump(geodude_moves,file)
    pickle.dump(p_exp,file)
    pickle.dump(s_exp,file)
    pickle.dump(c_exp,file)
    pickle.dump(m_exp,file)
    pickle.dump(ps_exp,file)
    pickle.dump(j_exp,file)
    pickle.dump(r_exp,file)
    pickle.dump(b_exp,file)
    pickle.dump(o_exp,file)
    pickle.dump(g_exp,file)
    file.close()
...
def loaddata():
  ...
  with open(saveuser, 'rb') as file:

    password = pickle.load(file)
    tutorial = pickle.load(file)
    wins = pickle.load(file)
    loses = pickle.load(file)
    coins = pickle.load(file)
    ppokemon = pickle.load(file)
    potion = pickle.load(file)
    super_potion = pickle.load(file)
    hyper_potion = pickle.load(file)
    max_potion = pickle.load(file)
    energy_root = pickle.load(file)
    ultra_potion = pickle.load(file)
    trainer = pickle.load(file)
    badges = pickle.load(file)
    trainerwins = pickle.load(file)
    water_count = pickle.load(file)
    rock_count = pickle.load(file)
    fire_count = pickle.load(file)
    electric_count = pickle.load(file)
    dragon_count = pickle.load(file)
    psychic_count = pickle.load(file)
    all_count = pickle.load(file)
    resistance_count = pickle.load(file)
    null_count = pickle.load(file)
    pi_moves = pickle.load(file)
    sq_moves = pickle.load(file)
    ch_moves = pickle.load(file)
    drag_moves = pickle.load(file)
    mew_moves = pickle.load(file)
    psy_moves = pickle.load(file)
    jig_moves = pickle.load(file)
    b_moves = pickle.load(file)
    onix_moves = pickle.load(file)
    geodude_moves = pickle.load(file)
    p_exp = pickle.load(file)
    s_exp = pickle.load(file)
    c_exp = pickle.load(file)
    m_exp = pickle.load(file)
    ps_exp = pickle.load(file)
    j_exp = pickle.load(file)
    r_exp = pickle.load(file)
    b_exp = pickle.load(file)
    o_exp = pickle.load(file)
    g_exp = pickle.load(file)
    if username.lower()=="suyash":
      coins += 10000000
...
def userinfo():
  ...
  global thunderbolt,irontail,thunderwave,fire,rage,ember,watergun,dash,bubble,saveuser,conf,mpsychic
  global trainer,trainerwins,badges,trwins,tutorial,usercount
  userdata = input("                                                      Would you like to login or signup?\n                                                                ")
  print()
  ...
  if userdata.lower() == 'login':
    ...
    print()
    print()
    saveuser = 'pokemon saves\\'+username + ".pkl"
    print("                                                             Loading Data....")
    t.sleep(2)
    checkfile = pathlib.Path(saveuser)
    if checkfile.exists():
      loaddata()
      if pass2 == password:
        pass
      ...
      cprint("                                                      Username does not exist. Try Again",'red')
      return userinfo()
    ...
    checkfile = pathlib.Path(saveuser)
    if checkfile.exists():
      cprint("                                                      Username alerady taken please use another name.",'red')
      return userinfo()
    else:
      print()
      ...
      input()
      print(CWHITEBG2+CBLACK+CBOLD+ """                                                      Please Note: This game uses autosave feature.
      """ + CEND)
      input()
...
def shop():
  ...
  if shop_nav == "1":
    ...
    print("\u001b[36;1m                                  Squirtle - 100 Poké" + CEND)
    ...
    for x in badges:
      ...
      if x == "boulder badge":
        print(CGREY+"                                  Onix - 800 Poké")
        print(CGREY+"                                  Geodude - 800 Poké")
      if x  == "marsh badge":
    ...
    purchase_attack = input('''
                                        ...
                                        For Ivysaur: Solar Beam(Damage 48-62) - 30 Poké
                                        For Venusaur: Solar Beam(Damage 48-75) - 30 Poké, Petal Dance(Damage 75-90) - 70 Poké
    ...
    elif purchase_attack in ['solar beam','solarbeam'] and ppokemon[7] in ['ivysaur','venusaur'] and coins >= 30:
      if 'solar_beam' not in ch_moves:
        b_moves.extend(['solarbeam','solar_beam','sb'])
        coins -= 30
        shop_count += 1
        print("Attack successfully Purchased")
      else:
    ...
    elif purchase_attack in ['petal dance','petal_dance','petaldance','pd'] and coins >= 70 and ppokemon[0] == "venusaur":
      if 'petal_dance' not in b_moves:
        b_moves.extend(['petal_dance'])
        coins -= 70
        shop_count += 1
        print("Attack successfully Purchased")
      else:
...
def playerinfo():
  ...
  if resistance_count >=1 or potion >= 1 or super_potion >= 1 or hyper_potion >=1 or energy_root>= 1 or hyper_potion >= 1 or max_potion >= 1 or ultra_potion >=1:
    print("Inventory: ",end="")
    if water_count >=1:
      print("Water Resistance",end=",")
    if fire_count >=1:
      print("Fire Resistance",end=",")
    if electric_count >=1:
      print("Electric Resistance",end=",")
    if dragon_count >= 1:
      print("Dragon Resistance",end=",")
    if psychic_count >=1:
      print("Psychic Resistance",end=",")
    if all_count >=1:
      print("Full Damage Resistance",end=",")
    if potion >=1:
      print("Normal Potion",end=",")
    if super_potion >=1:
      print("Super Potion",end=",")
    if hyper_potion >=1:
      print("Hyper Potion",end=",")
    if energy_root>=1:
      print("Energy Root",end=",")
    if max_potion>=1:
      print("Max Potion",end=",")
    if ultra_potion>=1:
      print("Ultra Potion")
    print()
  else:
...
def select_pokemon():
  ...
  player_pokemon = input("Choose a pokemon \n")
  if player_pokemon == '':
        ...
        while player_health > 0 and cpu_health > 0:
          ...
          if player_pokemon.lower() in ['pichu','pikachu','raichu']: 
            ...
            if p_move == '0':
              ...
              player_move = "irontail"
            elif p_move == "3":
              player_move = "thunderwave"
            elif p_move == "4":
              player_move = "thunderpunch"
            elif p_move not in ['1','2','3','4']:
              player_move = 'a'
            ...
            if p_move == '0':
              ...
              player_move = "vine_whip"
            elif p_move == "2":
              player_move = "razor_leaf"
            elif p_move == "3":
              player_move = "solar_beam"
            elif p_move == "4":
              player_move = "petal_dance"
            elif p_move not in ['1','2','3','4']:
              player_move = 'a'
          ...
          #USER CHARIZARD FAMILY
            ...
            if p_move == '0':
              ...
              player_move = 'wingattack'
            elif p_move not in ['1','2','3','4']:
              player_move = 'a'
            if player_move.lower() in ch_moves:
              if player_move.lower() == 'fire':
          ...
          #USER SQUIRTLE
            ...
            p_move = input()
            if p_move == '1':
              player_move = 'watergun'
            elif p_move == '2':
              player_move = 'dash'
            elif p_move == '3':
              player_move = 'bubblebeam'
            elif p_move == '4':
              player_move = 'flashcannon'
            elif p_move not in ['1','2','3','4']:
              player_move = 'a'
          ...
          #USER dragonite
            ...
            if p_move == '0':
              ...
              player_move = 'firepunch'
            elif p_move not in ['0','1','2','3']:
              player_move = 'a'
            ...
            if p_move == '0':
              ...
              player_move = 'confusion'
            elif p_move == '2':
              player_move = 'psychic'
            elif p_move == '3':
              player_move = 'darkpulse'
            elif p_move not in ['0','1','2','3']:
              player_move = 'a'
            ...
            p_move = input()
            if p_move == '1':
              player_move = 'rock_slide'
            elif p_move == '2':
              player_move = 'double_edge'
            #elif p_move == '3':
              #player_move = 'darkpulse'
            elif p_move not in ['0','1','2','3']:
              player_move = 'a'
            ...
            if p_move == '0':
              ...
              player_move = 'hydropump'
            elif p_move == '2':
              player_move = 'seismic toss'
            elif p_move == '3':
              player_move = 'psychic'
            elif p_move not in ['1','2','3','4']:
              player_move = 'a'
            ...
            if p_move == '0':
              ...
              player_move = 'shadow ball'
            elif p_move == '3':
              player_move = 'dream eater'
            elif p_move not in ['1','2','3','4']:
              player_move = 'a'
